    ...
    return (
        <div className="footer-bg">
                ...
                <Row className="text-white">
                    ...
                    <Col xs={6} md={3}>
                        <div className="single-footer-widget">
                            ...
                            <div className="widget-content">
                                <NavLink className="footer-link">Tele Services</NavLink>
                                <NavLink className="footer-link">Facility Services</NavLink>
            ...
            <div className="footer-copy-right text-center text-white">
                <p className='mb-0'>&copy; 2023 - <span className="developer">RJ</span> | All Rights Reserved</p>
            </div>
        </div>
    );
};
